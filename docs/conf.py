...
# -*- coding: utf-8 -*-
#
# jupyterlab_email documentation build configuration file, created by
...
_version_py = os.path.join('..', 'jupyterlab_email', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyterlab_emaildoc'
...
latex_documents = [
    (master_doc, 'jupyterlab_email.tex', 'jupyterlab_email Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'jupyterlab_email', 'jupyterlab_email Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jupyterlab_email', 'jupyterlab_email Documentation',
     author, 'jupyterlab_email', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    jupyterlab_email_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'jupyterlab_email'))
