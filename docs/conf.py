...
latex_documents = [
    (
        master_doc,
        "jupyterlab_email.tex",
        "jupyterlab_email Documentation",
        "Tim Paine",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "jupyterlab_email", "jupyterlab_email Documentation", [author], 1)
]
...
def run_apidoc(_):
    ...
    jupyterlab_email_dir = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "..", "jupyterlab_email")
    )
    ...
    subprocess.check_call(
        [cmd_path, "-E", "-M", "-o", out_dir, jupyterlab_email_dir, "--force"]
    )
