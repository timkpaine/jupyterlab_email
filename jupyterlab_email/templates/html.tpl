...
<img src="data:image/png;base64,{{output.metadata.filenames['image/png'] | posix_path }}"
{% else %}
<img src="data:image/jpeg;base64,{{ output.data['image/png'] }}" id="{{cell.execution_count}}" alt="{{cell.execution_count}}""
{% endif %}
